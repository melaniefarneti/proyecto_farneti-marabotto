...
func main() {
	...
	router.GET("/hotels", controllers.GetHotel)
	//router.GET("/reservations/:id", controllers.GetReservation)
	//router.POST("/reservations", controllers.CreateReservation(reservationService))
	//router.GET("/reservations/hotel/:hotelID/date/:date", controllers.GetReservationsByHotelAndDay(reservationService))
	//router.GET("/amenities", controllers.GetAmenities(amenityService))
